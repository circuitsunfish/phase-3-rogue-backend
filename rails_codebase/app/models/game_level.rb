class GameLevel < ApplicationRecord
  ...
  def api_getEntitiesForSession
    player = Entity.create(game_level_id: id, position_x: nil, position_y: nil, custom_emoji: nil,
                           attack_stat: nil, speed_stat: nil, hp_stat: nil)
    player.getPlayerEntityTypesForSession

    clown = Entity.create(game_level_id: id, position_x: nil, position_y: nil, custom_emoji: nil, attack_stat: nil,
                          speed_stat: nil, hp_stat: nil)
    clown.getClownEntityTypesForSession

    bed = Entity.create(game_level_id: id, position_x: nil, position_y: nil, custom_emoji: nil, attack_stat: nil,
                        speed_stat: nil, hp_stat: nil)
